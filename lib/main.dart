          ...
          Scrollbar(
              child: SingleChildScrollView(
                  ...
                  onPressed: () async {
                    try {
                      ...
                      if (tag.standard == "ISO 14443-4 (Type B)") {
                        ...
                        ndefString = ndefRecords
                            .map((r) => r.toString())
                            .reduce((value, element) => value + "\n" + element);

                        ndefString.split(' ').forEach((ch) => upiId.add(ch));
                        link = upiId.last.toString().substring(5);
                ...
                flag
                    ? ElevatedButton(
                        onPressed: () {
                          showAlertDialog(context,ndefString);
                        },
